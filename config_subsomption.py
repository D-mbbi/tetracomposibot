...
def initialize_robots(arena_size=-1, particle_box=-1): # particle_box: size of the robot enclosed in a square
    ...
    robots = []
    robots.append(robot_subsomption.Robot_player(4, y_center, 0, name="Robot sub", team="A"))
    robots.append(robot_braitenberg_avoider.Robot_player(x_center, y_center-1, 0, name="Robot 1", team="B"))
    robots.append(robot_braitenberg_avoider.Robot_player(x_center+2, y_center-1, 0, name="Robot 2", team="B"))
    return robots
